...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.rooViewController = [[SlipScrollViewController alloc] initWithNibName:@"SlipScrollViewController" bundle:nil];
    self.rooViewController.mainViewController = [[MainViewController alloc]init];
    self.rooViewController.leftViewController = [[LeftViewController alloc]init];
